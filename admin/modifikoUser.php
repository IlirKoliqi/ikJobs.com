                ...
                <div class="col-lg-9">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-2">Modifiko Perdorues</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <input class="btn btn-primary" id="login" value="Modifiko Perdoruesin" type="submit" name="modifiko" />
                            </form>
                        </div>
